    ...
    <ComingSoonMoviesProvider>
      ...
      >
          ...
          <BoxTitle>
            <PaperTitle>
              ...
              <Typography variant="body1" pt={2} color={"aliceblue"}>
                In this <strong>InforMovies</strong> you can watch information
                about movies
              </Typography>
            </PaperTitle>
          </BoxTitle>
            ...
            <Paper style={{ borderRadius: "5px" }}>
              ...
              <Box p={3} pt={1}>
                ...
                <Typography variant="paragraph" style={{ color: "#595a5c" }}>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Qo,
                  facilis quas rerum, mollitia voluptas, ipsum reicien is minima
                  nobis ad error iste cupiditate? Eius corporis doloremque
                  dolorem repudiandae possimus architecto impedit?
                </Typography>
              </Box>
            </Paper>{" "}
            <Paper style={{ borderRadius: "5px" }}>
        ...
        <BoxWithImages image={Serie}>
          <BoxTitle>
            <PaperTitle>
              <Typography variant="h4">And What about Tv series?</Typography>
              <Typography variant="body1" pt={2} color={"aliceblue"}>
                Also you can looking for information about tv series and you
                favorite.
              </Typography>
            </PaperTitle>
          </BoxTitle>
